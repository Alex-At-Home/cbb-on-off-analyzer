...
import TeamStyleExplorerChart from "../components/TeamStyleExplorerChart";

type Props = {
  testMode?: boolean; //works around SSR issues, see below
};
const TeamStyleExplorerPage: NextPage<Props> = ({ testMode }) => {
  ...
  function getRootUrl(params: TeamStatsExplorerParams) {
    return UrlRouting.getTeamStyleExplorer(params);
  }
...
export default TeamStyleExplorerPage;

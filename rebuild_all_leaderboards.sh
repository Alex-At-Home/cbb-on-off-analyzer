...
if [ "$YEARS" = "all" ] || [ "$YEARS" = "old" ]; then
   ...
   npm run build_leaderboards -- --tier=Combo --year=2023/24 $EXTRA
   ...
   npm run build_leaderboards -- --tier=Combo --year=2022/23 $EXTRA
   ...
   npm run build_leaderboards -- --tier=Combo --year=2021/22 $EXTRA
   ...
   npm run build_leaderboards -- --tier=Combo --year=2020/21 $EXTRA

...
import OffseasonTierListTable from "../components/OffseasonTierListTable";
...
const OffseasonLeaderboardPage: NextPage<Props> = ({ testMode }) => {
  ...
  function getRootUrl(params: OffseasonLeaderboardParams) {
    return UrlRouting.getOffseasonTierList(params);
  }
